...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('main/css/settings.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('main/css/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('main/css/navigation.css')}}">
...
<body>
				...
				<div id="slider4" class="rev_slider"  data-version="5.0">
					<ul>
						...
						<li data-transition="zoomout" 
							...
							<!-- MAIN IMAGE -->
							<img src="{{asset('main/sliders/3.jpg')}}" alt="Slide Background Image"  width="1920" height="1280">
							<!-- LAYER NR. 1 -->
							<div class="tp-caption" 
						        data-x="['left','left','left','left']" data-hoffset="['70','50','50','0']" 
								...
								data-responsive_offset="on">
		 						<div class="slide--headline">We are Rapidowallet, <br>Crypto & Blockchain  Advisor </div>
							</div>
							...
							<div class="tp-caption" 
								...
								data-splitout="none" 
								data-responsive_offset="on">
		 						<div class="slide--bio">Interested in crypto-currency since its very beginning of 2009, Collaborated <br>with a number of different companies in the crypto-world</div>
							</div>
		                ...
		                <li data-transition="boxslide" 				
							...
							data-masterspeed="2000">
							<!-- MAIN IMAGE -->
							<img src="{{asset('main/sliders/2.jpg')}}" alt="Slide Background Image"  width="1920" height="1280">
							<!-- LAYER NR. 1 -->
							<div class="tp-caption" 
						        data-x="['left','left','left','left']" data-hoffset="['75','60','60','20']" 
							...
							<!-- LAYER NR. 4 -->
							<div class="tp-caption" 
						        data-x="['left','left','left','left']" data-hoffset="['130','70','60','50']" 
								...
								data-responsive="off">
								<div class="slide-action">
									<a class="btn btn--white btn--bordered btn--rounded mr-30" href="#">Get in Touch</a>
		 						</div>
							</div>
						</li>
		                ...
		                <li data-transition="scaledownfromleft" 					
							...
							data-masterspeed="2000">
		 					<!-- MAIN IMAGE -->
							<img src="{{asset('main/sliders/4.jpg')}}" alt="Slide Background Image"  width="1920" height="1280">
							<!-- LAYER NR. 1 -->
							<div class="tp-caption" 
						        data-x="['left','left','left','left']" data-hoffset="['75','60','60','20']" 
							...
							<div class="tp-caption" 
								...
								data-responsive="off">
								<div class="slide-action">
									<a class="btn btn--white btn--bordered btn--rounded" href="#contactUs">Get Started</a>
		 						</div>
							</div>
						</li>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-5 col-md-6">
										<div class="action-button">
											<a href="#">
												<img src="{{asset('main/images/app-store.png')}}" alt="app store">
											</a>
											<a href="#">
												<img src="{{asset('main/images/google-play.png')}}" alt="app store">
											</a>
										</div>
									</div>
								</div>
			...
			<div class="footer-widget">
				<div class="container">
					<div class="row clearfix">
						...
						<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-links">
							...
							<div class="widget-content">
								<ul>
									...
									<li class="d-none"><a href="#">Meet Our Team</a></li>
									<li class="d-none"><a href="#">How It Works</a></li>
									<li class="d-none"><a href="#">Latest News</a></li>
						...
						<div class="col-xs-12 col-sm-4 col-md-2 footer--widget widget-links d-none">
							<div class="widget-title">
								<h5>Help & Support</h5>
							</div>
							<div class="widget-content">
						...
						<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-newsletter">
							...
							<div class="widget-content">
								...
								<div class="footer-social-icon">
									<a class="facebook" href="#" id="facebook">
										<i class="fa fa-facebook"></i><i class="fa fa-facebook"></i>
									</a>
									<a class="twitter" href="#" id="twitter">
										<i class="fa fa-twitter"></i><i class="fa fa-twitter"></i>
									</a>
									<a class="instagram d-none" href="#">
										<i class="fa fa-instagram"></i><i class="fa fa-instagram"></i>
									</a>	
									<a class="linkedin d-none" href="#">
	...
	<script src="{{asset('main/revolution/js/jquery.themepunch.tools.min838f.js?rev=5.0')}}"></script>
	<script src="{{asset('main/revolution/js/jquery.themepunch.revolution.min838f.js?rev=5.0')}}"></script>
	<script src="{{asset('main/revolution/js/extensions/revolution.extension.video.min.js')}}"></script>
	...
	<script src="{{asset('main/js/rsconfig.js')}}"></script>
